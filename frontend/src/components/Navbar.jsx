// import { ShoppingCart, UserPlus, LogOut, Lock,KeyRound} from "lucide-react";
            ...
            <div className='container mx-auto px-4 py-3'>
                <div className='flex flex-wrap justify-between items-center'>
                    <Link to='/' className='text-2xl font-bold text-emerald-400 flex items-center space-x-2'>
                        <img 
                            src="/MegaMart_logo_cleaned__1_-removebg-preview.png"
                            alt="MegaMart Logo"
                            className='h-12 w-12' 
                        />
                        <span className="text-amber-300">MegaMart🛒</span>
                    </Link>
