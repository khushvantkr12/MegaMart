...
//             // ✅ Parse product data from metadata
//             const products = JSON.parse(session.metadata.products);

//             console.log("✅ Products from session metadata:", products); // Debugging
...
//                     price: product.price,
//                     image: product.image  // ✅ Ensure image is included properly
//                 })),
//                 totalAmount,
...
//             await sendPaymentSuccessEmail(userEmail, req.user.name, products, totalAmount, newOrder._id);
